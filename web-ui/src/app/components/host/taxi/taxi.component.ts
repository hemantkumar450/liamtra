...
export class TaxiComponent implements OnInit {
  ...
  modal: boolean = false;
  modalStatus: string = '';
  serviceTypeId = ServiceCategoryEnum.HostTaxi;
  ...
  async submit() {
    ...
    this.taxiModel.svcTypeId = ServiceCategoryEnum.HostTaxi
    this.taxiModel.ownerUserId = 1;
    this.taxiModel.svcStatus = 10;
    this.taxiModel.hostStayDetail.svcTypeId = ServiceCategoryEnum.HostTaxi;
