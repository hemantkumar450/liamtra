...
export class UniqueHomeComponent implements OnInit {
  ...
  serviceTypeId = ServiceCategoryEnum.HostUniqueHome;
  ...
  async submit() {
    ...
    this.hostModel.svcTypeId = ServiceCategoryEnum.HostUniqueHome;
    this.hostModel.ownerUserId = 1;
    this.hostModel.hostStayDetail.svcTypeId = ServiceCategoryEnum.HostUniqueHome;
