...
export class SignUpComponent implements OnInit {
    ...
    async validatePhone() {
        try {
            ...
            this.signUp = response.data.Result;
            const obj = {
                Password: this.signUp.userPwd,
                UserName: this.signUp.userContactNo
            };
    ...
    routeCall(status) {
        this.router.navigate(['user-verify'],
            { queryParams: { userId: this.signUp.userId, mobile: this.signUp.userContactNo, mobileStatus: status } });
    }
