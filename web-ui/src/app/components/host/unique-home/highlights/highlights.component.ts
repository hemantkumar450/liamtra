...
export class HighlightsComponent implements OnInit {
  ...
  public highlightDropdownSettings = {};
  ...
  ngOnInit() {
    ...
    this.highlightDropdownSettings = {
      singleSelection: false,
      text: 'Select',
      enableSearchFilter: true,
      classes: 'myclass custom-class',
  ...
  public onAmenityDeSelectAll() {
    ...
    arr.forEach((item, index) => {
      if (item.svcCatgId === ServiceCategoryEnum.Amenities) {
        let hostIndex = this.hostModel.hostServiceLinkingSubCategories.findIndex(hostItem => hostItem.svcCatgId === item.svcCatgId)
  ...
  public onPlaceSelectAll(items: any) {
    this.onPlaceDeSelectAll();
    this.hostModel.hostServiceLinkingSubCategories = this.hostModel.hostServiceLinkingSubCategories.concat(items);
    this.hostModel.hostServiceLinkingSubCategories = Array.from(new Set(this.hostModel.hostServiceLinkingSubCategories));
  }

  public onPlaceDeSelectAll() {
    const arr = this.hostModel.hostServiceLinkingSubCategories.map(x => Object.assign({}, x));
    arr.forEach((item, index) => {
  ...
  public onHighlightSelectAll(items: any) {
    this.onHighlightDeSelectAll();
    this.hostModel.hostServiceLinkingSubCategories = this.hostModel.hostServiceLinkingSubCategories.concat(items);
    this.hostModel.hostServiceLinkingSubCategories = Array.from(new Set(this.hostModel.hostServiceLinkingSubCategories));
  }

  public onHighlightDeSelectAll() {
    const arr = this.hostModel.hostServiceLinkingSubCategories.map(x => Object.assign({}, x));
    arr.forEach((item, index) => {
  ...
  public onRuleSelectAll(items: any) {
    this.onRuleDeSelectAll();
    this.hostModel.hostServiceLinkingSubCategories = this.hostModel.hostServiceLinkingSubCategories.concat(items);
    this.hostModel.hostServiceLinkingSubCategories = Array.from(new Set(this.hostModel.hostServiceLinkingSubCategories));
  }

  public onRuleDeSelectAll() {
    const arr = this.hostModel.hostServiceLinkingSubCategories.map(x => Object.assign({}, x));
    arr.forEach((item, index) => {
  ...
  public onPolicySelectAll(items: any) {
    this.onPolicyDeSelectAll();
    this.hostModel.hostServiceLinkingSubCategories = this.hostModel.hostServiceLinkingSubCategories.concat(items);
    this.hostModel.hostServiceLinkingSubCategories = Array.from(new Set(this.hostModel.hostServiceLinkingSubCategories));
  }

  public onPolicyDeSelectAll() {
    const arr = this.hostModel.hostServiceLinkingSubCategories.map(x => Object.assign({}, x));
    arr.forEach((item, index) => {
